...
test("renders versioned data and creates a published-version schedule", async ({ page }) => {
  ...
  await page.route("**/api/platform/projects/platform-sauce/datasets", (route) => route.fulfill({
    ...
    body: JSON.stringify({ datasets: [{ id: "dataset-1", name: "Accounts", description: "Checkout accounts", createdAt: "2030-01-01T00:00:00.000Z", updatedAt: "2030-01-01T00:00:00.000Z", latestVersion: { id: "dataset-version-1", datasetId: "dataset-1", projectId: "platform-sauce", versionNumber: 2, columns: ["account", "expectedOrder"], rowCount: 24, checksum: "dataset-checksum", sourceName: "accounts.xlsx", createdAt: "2030-01-01T00:00:00.000Z" } }] }),
  }));
  ...
  await page.route("**/api/platform/projects/platform-sauce/schedules", async (route) => {
