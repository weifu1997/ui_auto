...
- [x] AC11：既有手工运行、dataset 单流程运行、schedule、webhook、通知、运行历史分页和 ManagedRunner 测试继续通过。（107 Python + 30 前端单测；批次专项 Playwright 2/2；2026-08-18 完整 `npm run test:e2e` 38/38 通过，遗留 E2E 已关闭。）
