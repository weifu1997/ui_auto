const SENSITIVE_KEY = /secret|url|token|password|keyword|signature|credential/i;

/** 审计详情脱敏：键名命中敏感词（secret/url/token/password/keyword/signature/credential）的值一律替换为星号；数组/对象递归处理。 */
