...
import { Button, Dropdown, Form, Input, Modal, Popconfirm, Select, Switch, Table, Tag, Tooltip } from "antd";
    ...
    <>
      ...
      <div className="governance-grid">
        ...
        <section className="surface governance-panel governance-members">
          ...
          <Table size="small" rowKey="id" pagination={false} dataSource={members} columns={[
